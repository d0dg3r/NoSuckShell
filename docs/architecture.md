...
- **Settings UI:** Settings → **Plugins** ([`AppSettingsPluginsTab.tsx`](../apps/desktop/src/components/settings/tabs/AppSettingsPluginsTab.tsx)): plugin store, list plugins, enable/disable, paste license token.
- **NSS-Commander** (built-in plugin `dev.nosuckshell.plugin.nss-commander`): [`plugins/file_workspace.rs`](../apps/desktop/src-tauri/src/plugins/file_workspace.rs) gates remote/local file browser UI and `sessionFileViews` in [`App.tsx`](../apps/desktop/src/App.tsx) / [`SplitWorkspace.tsx`](../apps/desktop/src/components/SplitWorkspace.tsx) / [`context-actions.ts`](../apps/desktop/src/features/context-actions.ts).
