...
- Pre-release: `vMAJOR.MINOR.PATCH-<prerelease>` (example: `v1.2.3-rc.1`, `v0.1.0-beta.6`)
...
- **Target tag:** `v0.1.0-beta.6` — push when you are ready; in-repo versions in `package.json`, `tauri.conf.json`, and `Cargo.toml` match this prerelease.
- **What ships:** see [CHANGELOG.md](CHANGELOG.md) for `0.1.0-beta.6`.
