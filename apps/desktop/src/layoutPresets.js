const leaf = (paneIndex) => ({
    id: `leaf-${paneIndex}`,
    type: "leaf",
    paneIndex,
});
const split = (id, axis, ratio, first, second) => ({
    id,
    type: "split",
    axis,
    ratio,
...
export const LAYOUT_PRESET_DEFINITIONS = [
    ...
    },
    {
        ...
        splitTree: split("preset-2x2-v", "vertical", 0.5, split("preset-2x2-t", "horizontal", 0.5, leaf(0), leaf(1)), split("preset-2x2-b", "horizontal", 0.5, leaf(2), leaf(3))),
    },
];
